...
optimizations for irregular applications and algorithms. The main research 
focus involves providing scalable data movement optimizations for different
irregular expressions with Sparse Matrix and Tensor kernels. We experiment on 
optimizations through different data structure layouts, and language and compiler 
expressions.
</p>
